...
from operation_drake.ingestion.normalizer import NormalizedMessage
from operation_drake.llm.base import LLMProvider
from operation_drake.models.schemas import IntentDecisionCreate
...
class RouterAgent(BaseAgent):
    ...
    def route(
        self, normalized: NormalizedMessage, channel: str, message_id: str
        ...
        resp = self.llm.complete(
            prompt=prompt, system="You are a routing agent. Respond with valid JSON only."
        )
